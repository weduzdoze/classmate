...
<cfset myFusebox.thisFuseaction = "add">
<cftry>
<cfoutput><cfinclude template="..\model/mClasses/qry_addClass.cfm"></cfoutput>
<cfcatch type="missingInclude">
<cfif Right(cfcatch.missingFilename, len("model/mClasses/qry_addClass.cfm") ) EQ "model/mClasses/qry_addClass.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_addClass.cfm in circuit mClasses which does not exist.">
<cfelse>
<cfrethrow>
</cfif>
</cfcatch>
